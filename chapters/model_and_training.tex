...
To train the model, a big dataset containing incorrect code examples and corrections with a large variety is needed. However such a dataset does not exist yet because the correction of erroneous code is a long and tedious work. That's why the errors have to be self introduced which of course is a non trivial task.
